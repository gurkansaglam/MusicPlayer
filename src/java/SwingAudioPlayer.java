...
public class SwingAudioPlayer extends JFrame implements ActionListener {
	...
	private JTextField URL = new JTextField("   Enter your favorite music's URL   ");
	...
	private JButton buttonMove = new JButton ("Move to Favorite");
	
	private JSlider sliderTime = new JSlider();
	private String MyArray[]={"    Select Your List    ","Pop","Classic","Country","Favorite"};
	private JComboBox selectionlist = new JComboBox(MyArray);
	...
	public SwingAudioPlayer() {
		...
		favpanel.setLayout(new GridLayout(6,1));
		favpanel.add(selectionlist);
		favpanel.add(empty1);
		//favpanel.add(empty2);
		//favpanel.add(empty3);
		favpanel.add(URL);
		favpanel.add(buttonMove);
	...
	private void openFile() {
		...
		if (selectionlist.getSelectedItem().equals("Pop")) {
			fileChooser = new JFileChooser("Pop");
		} else if (selectionlist.getSelectedItem().equals("Classic")) {
			fileChooser = new JFileChooser("Classic");
		} else if (selectionlist.getSelectedItem().equals("Country")){
			fileChooser = new JFileChooser("Country");
		} else if (selectionlist.getSelectedItem().equals("Favorite")){
			fileChooser = new JFileChooser("YourFav");
		}
	...
	public void movefile(String str){
		try{
	    	   ...
	    	   if(afile.renameTo(new File("YourFav" + afile.getName()))){
